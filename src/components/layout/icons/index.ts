import { Hash, ToggleLeft, Calendar, Mail, DollarSign, Percent, AlertCircle, List, Folder, Binary, Code, Ban, Text, CircleX } from 'lucide-react';

import { InferredType } from '@/data/lib/infer-type';

export const Icon = (type: InferredType) => {
  switch (type) {
